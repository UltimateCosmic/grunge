            ...
            <div className="space-y-6">
              ...
              <div>
                    ...
                    {product.discount && product.compare_at ? (
                      <>
                        <span className="text-3xl font-bold text-red-600">
                          {formatPriceInPEN(getCurrentPrice())}
                        </span>
                        <span className="text-xl text-gray-500 line-through">
                          {getOriginalPrice() !== null ? formatPriceInPEN(getOriginalPrice()!) : null}
                        </span>
                ...
                {product.availability ? (
                  <div className="mb-4">
                    ...
                    >
                      {selectedSize
                        ? `${selectedSize} disponible${product.quantity > 1 ? 's' : ''}`
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <button type="button" className="text-sm text-brand-600 underline cursor-pointer">Guía de tallas</button>
                      </DialogTrigger>
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-8 text-sm">
                          <div>
                            <h4 className="font-semibold mb-2">Polos y sudaderas (en pulgadas)</h4>
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">Talla</th>
                                  <th className="p-2 border">Ancho</th>
                                  <th className="p-2 border">Largo</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">Small</td><td className="p-2 border">34-36</td><td className="p-2 border">27</td></tr>
                                <tr><td className="p-2 border">Medium</td><td className="p-2 border">38-40</td><td className="p-2 border">28 1/2</td></tr>
                                <tr><td className="p-2 border">Large</td><td className="p-2 border">42-44</td><td className="p-2 border">29 1/2</td></tr>
                                <tr><td className="p-2 border">X-Large</td><td className="p-2 border">46-48</td><td className="p-2 border">31</td></tr>
                                <tr><td className="p-2 border">XX-Large</td><td className="p-2 border">50-52</td><td className="p-2 border">32</td></tr>
                                <tr><td className="p-2 border">XXX-Large</td><td className="p-2 border">54-56</td><td className="p-2 border">33 1/2</td></tr>
                                <tr><td className="p-2 border">XXXX-Large</td><td className="p-2 border">58-60</td><td className="p-2 border">34 1/2</td></tr>
                              </tbody>
                            </table>
                            <p className="text-xs text-gray-500">*Todas las medidas son aproximadas</p>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">Gorras Flex/Baseball (en pulgadas)</h4>
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">Talla</th>
                              ...
                              <tbody>
                                <tr><td className="p-2 border">Small/Medium</td><td className="p-2 border">6 3/4 - 7 1/4</td></tr>
                                <tr><td className="p-2 border">Large/X-Large</td><td className="p-2 border">7 1/8 - 7 5/8</td></tr>
                              </tbody>
                            </table>
                            <p className="text-xs text-gray-500">*Todas las medidas son aproximadas</p>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">Polos Girls Junior</h4>
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">Nuestra talla</th>
                                  <th className="p-2 border">Talla Junior</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">Small</td><td className="p-2 border">3/4</td></tr>
                                <tr><td className="p-2 border">Medium</td><td className="p-2 border">5/6</td></tr>
                                <tr><td className="p-2 border">Large</td><td className="p-2 border">7/8</td></tr>
                                <tr><td className="p-2 border">X-Large</td><td className="p-2 border">9/10</td></tr>
                              </tbody>
                            </table>
                            <p className="text-xs text-gray-500">*Todas las medidas son aproximadas</p>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">Tallas Juveniles</h4>
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">Nuestra talla</th>
                                  <th className="p-2 border">Talla juvenil</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">Small</td><td className="p-2 border">6-8</td></tr>
                                <tr><td className="p-2 border">Medium</td><td className="p-2 border">10-12</td></tr>
                                <tr><td className="p-2 border">Large</td><td className="p-2 border">14-16</td></tr>
                                <tr><td className="p-2 border">X-Large</td><td className="p-2 border">18-20</td></tr>
                              </tbody>
                            </table>
                            <p className="text-xs text-gray-500">*Todas las medidas son aproximadas</p>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">Baby Dolls/Fitted & Raglan Tees/Tanks (en pulgadas)</h4>
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">Talla</th>
                                  <th className="p-2 border">Busto</th>
                                  <th className="p-2 border">Cintura</th>
                                  <th className="p-2 border">Largo</th>
                                  <th className="p-2 border">Talla vestido</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">Small</td><td className="p-2 border">28</td><td className="p-2 border">26</td><td className="p-2 border">22 1/8</td><td className="p-2 border">0-2</td></tr>
                                <tr><td className="p-2 border">Medium</td><td className="p-2 border">30</td><td className="p-2 border">28</td><td className="p-2 border">22 3/4</td><td className="p-2 border">4-6</td></tr>
                                <tr><td className="p-2 border">Large</td><td className="p-2 border">33</td><td className="p-2 border">31</td><td className="p-2 border">23 3/8</td><td className="p-2 border">8-10</td></tr>
                                <tr><td className="p-2 border">X-Large</td><td className="p-2 border">35</td><td className="p-2 border">33</td><td className="p-2 border">24</td><td className="p-2 border">12</td></tr>
                              </tbody>
                            </table>
                            <p className="text-xs text-gray-500">*Todas las medidas son aproximadas</p>
                          </div>
                          <div>
                            ...
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">USA Hombres</th>
                                  <th className="p-2 border">3.5</th><th className="p-2 border">4</th><th className="p-2 border">4.5</th><th className="p-2 border">5</th><th className="p-2 border">5.5</th><th className="p-2 border">6</th><th className="p-2 border">6.5</th><th className="p-2 border">7</th><th className="p-2 border">7.5</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">USA Mujeres</td><td className="p-2 border">5</td><td className="p-2 border">5.5</td><td className="p-2 border">6</td><td className="p-2 border">6.5</td><td className="p-2 border">7</td><td className="p-2 border">7.5</td><td className="p-2 border">8</td><td className="p-2 border">8.5</td><td className="p-2 border">9</td></tr>
                                <tr><td className="p-2 border">Europa</td><td className="p-2 border">-</td><td className="p-2 border">36</td><td className="p-2 border">-</td><td className="p-2 border">37</td><td className="p-2 border">38</td><td className="p-2 border">-</td><td className="p-2 border">39</td><td className="p-2 border">40</td><td className="p-2 border">-</td></tr>
                                <tr><td className="p-2 border">U.K.</td><td className="p-2 border">2.5</td><td className="p-2 border">3</td><td className="p-2 border">3.5</td><td className="p-2 border">4</td><td className="p-2 border">4.5</td><td className="p-2 border">5</td><td className="p-2 border">5.5</td><td className="p-2 border">6</td><td className="p-2 border">6.5</td></tr>
                                <tr><td className="p-2 border">Japón</td><td className="p-2 border">-</td><td className="p-2 border">220</td><td className="p-2 border">-</td><td className="p-2 border">230</td><td className="p-2 border">235</td><td className="p-2 border">-</td><td className="p-2 border">245</td><td className="p-2 border">250</td><td className="p-2 border">-</td></tr>
                              </tbody>
                            </table>
                          </div>
                          <div>
                            ...
                            <table className="w-full text-xs border mb-4">
                              <thead>
                                <tr className="bg-gray-100">
                                  <th className="p-2 border">USA Hombres</th>
                                  <th className="p-2 border">8</th><th className="p-2 border">8.5</th><th className="p-2 border">9</th><th className="p-2 border">9.5</th><th className="p-2 border">10</th><th className="p-2 border">10.5</th><th className="p-2 border">11</th><th className="p-2 border">11.5</th><th className="p-2 border">12</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr><td className="p-2 border">USA Mujeres</td><td className="p-2 border">9.5</td><td className="p-2 border">10</td><td className="p-2 border">10.5</td><td className="p-2 border">11</td><td className="p-2 border">11.5</td><td className="p-2 border">12</td><td className="p-2 border">12.5</td><td className="p-2 border">13</td><td className="p-2 border">13.5</td></tr>
                                <tr><td className="p-2 border">Europa</td><td className="p-2 border">41</td><td className="p-2 border">42</td><td className="p-2 border">-</td><td className="p-2 border">43</td><td className="p-2 border">44</td><td className="p-2 border">-</td><td className="p-2 border">45</td><td className="p-2 border">46</td><td className="p-2 border">-</td></tr>
                                <tr><td className="p-2 border">U.K.</td><td className="p-2 border">7</td><td className="p-2 border">7.5</td><td className="p-2 border">8</td><td className="p-2 border">8.5</td><td className="p-2 border">9</td><td className="p-2 border">9.5</td><td className="p-2 border">10</td><td className="p-2 border">10.5</td><td className="p-2 border">11</td></tr>
                                <tr><td className="p-2 border">Japón</td><td className="p-2 border">260</td><td className="p-2 border">265</td><td className="p-2 border">-</td><td className="p-2 border">275</td><td className="p-2 border">280</td><td className="p-2 border">-</td><td className="p-2 border">290</td><td className="p-2 border">-</td><td className="p-2 border">-</td></tr>
                              </tbody>
                            </table>
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {product.sizes.map((size: string) => {
                      ...
                      const isAvailable = variant?.availability !== false;
              ...
              <div className="space-y-3">
                <Button
                  ...
                  disabled={!product.availability || (!selectedVariant && !selectedSize)}
                  onClick={() => {
                ...
                <div className="flex gap-3">
                  ...
                  >
                    <Button
                      ...
                      disabled={!product.availability || (!selectedVariant && !selectedSize)}
                    >
                      <span className="font-semibold">Comprar en</span>
